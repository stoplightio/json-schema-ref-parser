 ...
 * @returns {Promise} - The returned promise resolves with the parsed JSON schema object.
 */
$RefParser.prototype.parse = async function (..._args) {
  let args = normalizeArgs(_args);
  let promise;
 ...
 * The returned promise resolves with a {@link $Refs} object containing the resolved JSON references
 */
$RefParser.prototype.resolve = async function (..._args) {
  let me = this;
  let args = normalizeArgs(_args);
 ...
 * @returns {Promise} - The returned promise resolves with the bundled JSON schema object.
 */
$RefParser.prototype.bundle = async function (..._args) {
  let me = this;
  let args = normalizeArgs(_args);
 ...
 * @returns {Promise} - The returned promise resolves with the dereferenced JSON schema object.
 */
$RefParser.prototype.dereference = async function (..._args) {
  let me = this;
  let args = normalizeArgs(_args);
